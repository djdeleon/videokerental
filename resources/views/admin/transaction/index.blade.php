...
@section('content')
<h4 class="font-weight-bold pb-3 mb-0">Transaction List</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
    ...
    <table class="table table-bordered" id="table1">
        ...
        <tbody>
            ...
            @endforeach
            @foreach ($anotherTransaction as $another)
                <tr>
                    <td>{{ $another->id - 2 }}</td>
                    <td>{{ $another->user->first_name }} {{ $another->user->last_name }}</td>
                    <td>{{ $another->payment->name }}</td>
                    <td>{{ $another->videoke->price }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
