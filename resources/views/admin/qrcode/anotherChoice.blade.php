...
<div class="container" style="padding-top: 25vh;">
    <div class="row text-center">
        <div class="col-md-12">
            ...
            <h2><a href="/admin/customer/{{ $anotherReservation->id }}/access/confirm">Camera</a> | <a href="/admin/customer/{{ $anotherReservation->id }}/access/another-confirm-file">Files</a></h2>
        </div>
    </div>
</div>
