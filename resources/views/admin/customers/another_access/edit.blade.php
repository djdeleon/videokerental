...
<div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-prevent-multiple-submits" method="POST" action="/admin/customer/{{ $anotherReservation->id }}/access">
                        @method('PATCH')
                        @csrf
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="usertype" class="form-control" required name="usertype" autocomplete="usertype" autofocus>
                                    <option>{{ $anotherReservation->user->usertype }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="is_expired" class="form-control" required name="is_expired" autocomplete="is_expired" autofocus>
                                    <option>{{ $anotherReservation->user->is_expired }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="is_paid" class="form-control"  name="is_paid" autocomplete="is_paid" autofocus>
                                    <option>{{ $anotherReservation->is_paid }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="is_return" class="form-control" required name="is_return" autocomplete="is_return" autofocus>
                                    <option>{{ $anotherReservation->is_return }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="btn-group btn-group-md">
                                    ...
                                    <a href="/admin/customer/{{ $anotherReservation->id }}/access" class="btn btn-outline-secondary ml-4">Back</a>
                                </div>
                            </div>
                        </div>
                    </form>
