...
@section('content')
<h4 class="font-weight-bold pb-3 mb-0">Edit Videoke</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/admin"><i class="feather icon-home"></i></a></li>
        <li class="breadcrumb-item active">Videoke</li>
        <li class="breadcrumb-item active">Videoke Lists</li>
        <li class="breadcrumb-item active">Edit Videoke</li>
    </ol>
</div>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Videoke Update</div>

                <div class="card-body">
                    <form method="POST" action="/admin/videokelists/{{ $videokeTotal->id }}">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="number" class="form-control @error('number') is-invalid @enderror" name="number" value="{{ old('number') ?? $videokeTotal->number }}" autocomplete="number" autofocus>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="btn-group btn-group-md">
                                    <button type="submit" class="btn btn-outline-primary">Edit Videoke</button>
