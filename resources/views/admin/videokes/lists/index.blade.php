...
@section('content')
<h4 class="font-weight-bold pb-3 mb-0">Videoke List</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/admin"><i class="feather icon-home"></i></a></li>
        <li class="breadcrumb-item active">Videoke</li>
        <li class="breadcrumb-item active">Videoke List</li>
    </ol>
</div>

    <p><a href="/admin/videokelists/create" class="btn btn-outline-primary">Add New Videoke</a></p>
                ...
                <tr>
                    ...
                    <td width="10">
                        <div class="btn-group">
                            ...
                            <a href="/admin/videokelists/{{ $videoke->id }}/edit" class="btn btn-outline-primary" style="margin: 4px;">Edit</a>
                            <form action="/admin/videokelists/{{ $videoke->id }}" method="post">
                                @csrf
                                @method('DELETE')
