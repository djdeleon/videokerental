...
@section('content')
<h4 class="font-weight-bold pb-3 mb-0">Report</h4>
        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td width="10">
                        <div class="btn-group">
                            <a href="/admin/report" class="btn btn-outline-danger ml-2">PDF</a>
                            <a href="/admin/report" class="btn btn-outline-success ml-2">Excel</a>
                            <a href="/admin/report" class="btn btn-outline-primary ml-2">Print</a>
                        </div>
                    </td>
                </tr>
            @endforeach
